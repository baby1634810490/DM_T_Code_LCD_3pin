...
#if defined(DUAL_CORE)
MODIFY_REG (SYSCFG->CFGR, SYSCFG_CFGR_AXISRAML| SYSCFG_CFGR_ITCML| SYSCFG_CFGR_DTCML| SYSCFG_CFGR_SRAM1L
| SYSCFG_CFGR_SRAM2L| \
...
{
    return ((READ_BIT(SYSCFG->UR5, SYSCFG_UR5_WRPN_BANK1) == (SYSCFG_UR5_WRPN_BANK1 &
